...
public class Scoreboard implements ActionListener, Cloneable {
   ...
   public Scoreboard(Instruction [] iIn){
        ...
        fus = new FunctionalUnit[7]; //setup the function unit array for proceeding fu types

        //per the project specification, the below set of functional units is available
        IntegerFunctionalUnit integer1 = new IntegerFunctionalUnit("Integer"); //integer fu 1/2
        IntegerFunctionalUnit integer2 = new IntegerFunctionalUnit("Integer"); //integer fu 2/2
        AddFunctionalUnit adder1 = new AddFunctionalUnit("Add");               //adder fu 1/2
        AddFunctionalUnit adder2 = new AddFunctionalUnit("Add");               //adder fu 2/2
        MultiplyFunctionalUnit mult1 = new MultiplyFunctionalUnit("Mult1");    //mult fu 1/2
        MultiplyFunctionalUnit mult2 = new MultiplyFunctionalUnit("Mult2");    //mult fu 2/2
        DivideFunctionalUnit divide = new DivideFunctionalUnit("Divide");      //div fu 1/1

        fus[0] = integer1; //store the above intantiated integer unit in fu array
        fus[1] = integer2; //store the above intantiated integer unit in fu array
        fus[2] = adder1;   //store the above intantiated integer unit in adder array
        fus[3] = adder2;   //store the above intantiated integer unit in adder array
        fus[4] = mult1;    //store the above intantiated integer unit in mult array
        fus[5] = mult2;    //store the above intantiated integer unit in mult array
        fus[6] = divide;   //store the above intantiated integer unit in divide array
